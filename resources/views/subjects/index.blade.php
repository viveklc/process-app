                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('admin.subjects.show', $subject->id) }}" class="menu-link px-3">                                {{ trans('global.view') }}</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('admin.subjects.edit', $subject->id) }}" class="menu-link px-3">                                {{ trans('global.edit') }}
                                                            </a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('admin.subjects.destroy', $subject->id) }}" method="POST" id="frmDeleteorganization-{{ $subject->id }}" style="display: inline-block; width: 100%;">
                                                                <input type="hidden" name="_method" value="DELETE">
                                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <a href="#"  class="menu-link px-3" onclick="deleteGridRecord('frmDeleteorganization-{{ $subject->id }}')">
                                                            {{ trans('global.delete') }}
                                                            </a>
                                                        </form>
                                                        </div>
                ...
                language: {
                    ...
                    @if ($subjects->count())
                        info: '{{ trans('global.grid_pagination_count_status', [
                            'firstItem' => $subjects->firstItem(),
                            'lastItem' => $subjects->lastItem(),
