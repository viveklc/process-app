                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('admin.departments.destroy', $department->id) }}"
                                                                method="POST" id="frmDeleteDepartment-{{ $department->id }}"
                                                                style="display: inline-block; width: 100%;">
                                                                <input type="hidden" name="_method" value="DELETE">
                                                                <input type="hidden" name="_token"
                                                                    value="{{ csrf_token() }}">
                                                                <a href="#" class="menu-link px-3"
                                                                    onclick="deleteGridRecord('frmDeleteDepartment-{{ $department->id }}')">
                                                                    {{ trans('global.delete') }}
                                                                </a>
                                                            </form>
                                                        </div>
                ...
                language: {
                    ...
                    @if ($departments->count())
                        info: '{{ trans('global.grid_pagination_count_status', [
                            'firstItem' => $departments->firstItem(),
                            'lastItem' => $departments->lastItem(),
