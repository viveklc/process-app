            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        @if (request()->get('chapter_id'))
                            <a href="{{ route('admin.pages.create', ['chapter_id' => request()->get('chapter_id')]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($pages as $page)
                                            <tr data-entry-id="{{ $page->id }}">
                                                ...
                                                <td>
                                                    <a target="_blank" href="{{ $page->page_content }}">
                                                        {{ $page->page_content_url }} </a>
                                                </td>
                                                <td>
                                                    {{ $page->page_sequence }}
                                                </td>
                                                    ...
                                                    @if (request()->get('chapter_id'))
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('admin.pages.show', $page->id) . '?chapter_id=' . request()->get('chapter_id') }}"
                                                                    class="menu-link px-3"> {{ trans('global.view') }}</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('admin.pages.edit', $page->id) . '?chapter_id=' . request()->get('chapter_id') }}"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <form
                                                                    ...
                                                                    method="POST" id="frmDeletePage-{{ $page->id }}"
                                                                    style="display: inline-block; width: 100%;">
                                                                    <input type="hidden" name="_method" value="DELETE">
                                                                    <input type="hidden" name="_token"
                                                                        value="{{ csrf_token() }}">
                                                                    <a href="#" class="menu-link px-3"
                                                                        onclick="deleteGridRecord('frmDeletePage-{{ $page->id }}')">
                                                                        {{ trans('global.delete') }}
                                                                    </a>
                                                                </form>
                                                            </div>
        ...
        $(function() {
                ...
                language: {
                    ...
                    @if ($pages->count())
                        info: '{{ trans('global.grid_pagination_count_status', [
                            'firstItem' => $pages->firstItem(),
                            'lastItem' => $pages->lastItem(),
                            'total' => $pages->total(),
                        ]) }}',
                    @endif
                },
            ...
            $('#dataTableSearch').on('keyup', function(e) {
                if (e.which == 13) { // if user press enter in search text input
                    ...
                    let url = '{{ route('admin.pages.index') }}' + generateQueryString(
                        requestParameters);
                    @if (request()->get('chapter_id'))
                        url += '&chapter_id=' + '{{ request()->get('chapter_id') }}'
                    @endif
