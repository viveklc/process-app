            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-7">
                        <form id="" class="form" method="POST" action="{{ route("admin.tags.store") }}" enctype="multipart/form-data">
                            @csrf
                            <!--begin::Input group-->
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid  {{ $errors->has('tag_name') ? 'is-invalid' : '' }}" placeholder="Tag Name" name="tag_name" value="{{ old('tag_name', '') }}" required />
                            </div>
                            <!--end::Input group-->
