       ...
       <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
          ...
          <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
             ...
             <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Countries</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
             ...
             <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('admin.countries.create') }}" class="btn btn-sm fw-bold btn-primary">{{ trans('global.add') }}</a>
                <!--end::Primary button-->
             </div>
             <!--end::Actions-->
          </div>
                 ...
                 <tbody>
                     @foreach ($countries as $country)
                         <tr data-entry-id="{{ $country->id }}">
                             ...
                             <td>
                                  @if($country->getFirstMediaUrl('Country') !== null)
                                     <a href="{{ $country->getFirstMediaUrl('Country') }}" target="_BLANK">
                                         <img src="{{ $country->getFirstMediaUrl('Country', 'thumb') }}" />
                                     </a>
                                 @endif
                             </td>
                     <!--begin::Action=-->
                     <td class="text-end">
                         ...
                         <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                             ...
                             <div class="menu-item px-3">
                                 <a href="{{ route('admin.countries.show', $country->id) }}" class="menu-link px-3">                                {{ trans('global.view') }}</a>
                             </div>
                             <!--end::Menu item-->
                             <!--begin::Menu item-->
                             <div class="menu-item px-3">
                                 <a href="{{ route('admin.countries.edit', $country->id) }}" class="menu-link px-3">                                {{ trans('global.edit') }}
                                 </a>
                             </div>
                             <!--end::Menu item-->
                             <!--begin::Menu item-->
                             <div class="menu-item px-3">
                                 <form action="{{ route('admin.countries.destroy', $country->id) }}" method="POST" id="frmDeleteCountry-{{ $country->id }}" style="display: inline-block; width: 100%;">
                                     <input type="hidden" name="_method" value="DELETE">
                                     <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                 <a href="#"  class="menu-link px-3" onclick="deleteGridRecord('frmDeleteCountry-{{ $country->id }}')">
                                 {{ trans('global.delete') }}
                                 </a>
                             </form>
                             </div>
        ...
        $(function() {
            ...
            $('#dataTableSearch').on('keyup', function(e) {
                if (e.which == 13) { // if user press enter in search text input
                    ...
                    window.location.href = '{{ route('admin.countries.index') }}' + generateQueryString(
                        requestParameters);
                } else {
