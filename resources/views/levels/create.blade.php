            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-7">
                        <form id="" class="form" method="POST" action="{{ route("admin.levels.store") }}" enctype="multipart/form-data">
                            @csrf
                            <!--begin::Input group-->
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!--end::Label-->
                                <select class="form-select form-control form-select-solid {{ $errors->has('course_id') ? 'is-invalid' : '' }}"  style="width: 100%;" name="course_id" id="course_id" required >

                                    @foreach($courses as $id => $courseName)
                                        <option value="{{ $id }}" {{ old('course_id') == $id ? 'selected' : '' }}>{{ $courseName }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid  {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="Level Name" name="name" value="{{ old('name', '') }}" required />
                            </div>
                            <!--end::Input group-->
