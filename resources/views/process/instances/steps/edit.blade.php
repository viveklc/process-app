                        ...
                        <div class="card-body pt-7">
                            <form id="kt_subscriptions_export_form" class="form" method="POST"
                                ...
                                <div class="d-flex flex-column mb-8 fv-row substepdiv">
                                    ...
                                    <select
                                        ...
                                        @forelse ($processSteps as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('is_child_of_step_id',$stepInstance->is_child_of_step_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                            </option>
                                        @empty
                                        @endforelse
                                    </select>
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <input type="file"
                                    ...
                                    placeholder="Attachment" name="attachments[]" multiple value="{{ old('attachments') }}" />
