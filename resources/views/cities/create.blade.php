                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-7">
                            <form id="" class="form" method="POST" action="{{ route('admin.cities.store') }}"
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <select
                                        ...
                                        @foreach ($countries as $id => $countryName)
                                            <option value="{{ $id }}"
                                                {{ old('country_id') == $id ? 'selected' : '' }}>{{ $countryName }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="City Name" name="name" value="{{ old('name', '') }}" required />
                                </div>
                                <!--end::Input group-->
