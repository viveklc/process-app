                                    ...
                                    <tbody>
                                        @foreach ($courses as $course)
                                            <tr data-entry-id="{{ $course->id }}">
                                                ...
                                                <td>
                                                    @if($course->getFirstMediaUrl('Course') !== null)
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('admin.courses.show', $course->id) }}" class="menu-link px-3">                                {{ trans('global.view') }}</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('admin.courses.edit', $course->id) }}" class="menu-link px-3">                                {{ trans('global.edit') }}
                                                            </a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('admin.courses.destroy', $course->id) }}" method="POST" id="frmDeleteCourse-{{ $course->id }}" style="display: inline-block; width: 100%;">
                                                                <input type="hidden" name="_method" value="DELETE">
                                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <a href="#"  class="menu-link px-3" onclick="deleteGridRecord('frmDeleteCourse-{{ $course->id }}')">
                                                            {{ trans('global.delete') }}
                                                            </a>
                                                        </form>
                                                        </div>
        ...
        $(function() {
            ...
            $('#dataTableSearch').on('keyup', function(e) {
                if (e.which == 13) { // if user press enter in search text input
                    ...
                    window.location.href = '{{ route('admin.courses.index') }}' + generateQueryString(
                        requestParameters);
                } else {
