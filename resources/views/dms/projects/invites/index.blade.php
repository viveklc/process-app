                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('dms.project.invites.index',$id) }}">Invited Email</a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="{{ route('dms.project.invites.create',$id) }}" id="add_user"
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered datatable datatable-Cities">
                                    ...
                                    <tbody>
                                        @forelse ($projectInvites as $i=>$item)
                                            <tr data-entry-id="{{ $item->id }}">
                                                <td></td>
                                                <td>{{ $item->user_email }}</td>
                                                <td>{{ $item->invited_for_role }}</td>
                                                <td>{{ $item->invitedBy->name }}</td>
                                                <td>{{ $item->invite_status == 1 ? 'Pending' :'approved' }}</td>
                                                <td>{{ appDateFormat($item->invite_valid_upto) }}</td>
