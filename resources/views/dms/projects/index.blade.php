            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="{{ route('dms.projects.create') }}"
...
{{--
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('dms.project.invites.index', $item->id) }}"
                                                            class="menu-link px-3"> Invites
                                                        </a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('dms.projects.edit', $item->id) }}"
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('dms.projects.show', $item->id) }}"
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('dms.projects.destroy', $item->id) }}"
        ...
        $(function() {
            ...
            $('#dataTableSearch').on('keyup', function(e) {
                if (e.which == 13) { // if user press enter in search text input
                    ...
                    window.location.href = '{{ route('dms.projects.index') }}' + generateQueryString(
                        requestParameters);
                } else {
