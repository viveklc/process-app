            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('dms.document-tags.index') }}">Document Tags</a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="{{ route('dms.document-tags.create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($tags as $tag)
                                            <tr data-entry-id="{{ $tag->id }}">
                                                ...
                                                <td>
                                                    {{ $tag->document_tag_name ?? '' }}
                                                </td>
                                                <td>
                                                    {{ $tag->document_tag_type }}
                                                </td>
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('dms.document-tags.edit', $tag->id) }}"
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('dms.document-tags.destroy', $tag->id) }}"
                                                                method="POST" id="frmDeleteTag-{{ $tag->id }}"
                                                                style="display: inline-block; width: 100%;">
                                                                <input type="hidden" name="_method" value="DELETE">
                                                                <input type="hidden" name="_token"
                                                                    value="{{ csrf_token() }}">
                                                                <a href="#" class="menu-link px-3"
                                                                    onclick="deleteGridRecord('frmDeleteTag-{{ $tag->id }}')">
                                                                    {{ trans('global.delete') }}
                                                                </a>
                                                            </form>
                                                        </div>
        ...
        $(function() {
            ...
            @can('delete-tag')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('dms.document-tags.massDestroy') }}",
...
<<<<<<< HEAD
            table = $('.datatable-Tags:not(.ajaxTable)').DataTable({
=======
            table = $('.datatable-Cities:not(.ajaxTable)').DataTable({
>>>>>>> feature/satyendra-course-crud
                buttons: dtButtons
            })
            ...
            $('#dataTableSearch').on('keyup', function(e) {
                if (e.which == 13) { // if user press enter in search text input
                    ...
                    window.location.href = '{{ route('admin.tags.index') }}' + generateQueryString(
                        requestParameters);
                } else {
