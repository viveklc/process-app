...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('books', function (Blueprint $table) {
            ...
            $table->text('front_cover_image_url')->nullable()->comment('Managed by spatie media library');
            $table->text('back_cover_image_url')->nullable()->comment('Managed by spatie media library');
